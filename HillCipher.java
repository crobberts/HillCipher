...
class HillCipher {
    ...
    public static String encrypt(ArrayList<ArrayList<Integer>> message, ArrayList<ArrayList<Integer>> k, int radix) {
        ArrayList<ArrayList<Integer>> enc = matrixMultiply(k, message, radix);
        String encrypted = matrixToString(enc);
        return encrypted;
    }

    public static String decrypt(String message, String k, int radix) {
        ArrayList<ArrayList<Integer>> key = stringToMatrix(k.toUpperCase());
        ArrayList<ArrayList<Integer>> msg = stringToMatrix(message.toUpperCase());
        ArrayList<ArrayList<Integer>> enc = matrixMultiply(key, msg, radix);
        String decrypted = matrixToString(enc);
